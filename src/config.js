...
// export const NOTION_DOMAIN = (process.env.NODE_ENV === 'development') ? `https://cors-anywhere.herokuapp.com/${NOTION_DATABASE_URL}/${NOTION_DATABASE_ID}` : `${NOTION_DATABASE_URL}/${NOTION_DATABASE_ID}`
